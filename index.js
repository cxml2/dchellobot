...
client.on('message', msg => {
  ...
  if (aitoggled){
    ...
    msg.channel.send("Cool!");
      ...
      msg.channel.send(">>> **Bored Menu**\n\n• Use fun commands like .ascii or .joke\n• Watch CatR3kd on twitch\n• Play a game\n• Do something other than discord");
...
" channels of " + client.guilds.size + " server\(s\)");
    ...
    msg.channel.send("invite link： https://discord.com/api/oauth2/authorize?client_id=856051979817189396&permissions=0&scope=bot");
